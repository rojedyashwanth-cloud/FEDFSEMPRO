          ...
          <section id="plans">
            ...
            <div className="plansName">
              <div className="plan">
                ...
                <button className="cart" onClick={() => handleSubscribe('Basic', 250)}>Subscribe</button>
              </div>
              <div className="plan">
                <h3>Medium</h3>
                <ul>
                ...
                <button className="cart" onClick={() => handleSubscribe('Medium', 500)}>Subscribe</button>
              </div>
              <div className="plan">
                <h3>Pro</h3>
                <ul>
                ...
                <button className="cart" onClick={() => handleSubscribe('Pro', 1000)}>Subscribe</button>
              </div>
            </div>
          </section>
        ) : (
